...
2. Clone repo ini
```bash
git clone https://github.com/bilxdi/H1D024074-PraktikumKB-Responsi.git
```
3. Run Python File untuk menjalankan diagnosa

### Contoh Eksekusi
```
=== SISTEM DIAGNOSA GANGGUAN PENCERNAAN ===
Jawablah pertanyaan berikut dengan angka yang sesuai.

1. Berapa kali Anda BAB cair hari ini? (0-15): 1
2. Seberapa parah mual/muntah Anda? (Skala 0-10) (0-10): 2
3. Berapa suhu tubuh Anda saat ini? (Celcius) (36.0-41.0): 36
4. Sudah berapa hari Anda mengalami diare? (0-14): 1
5. Seberapa parah gejala muncul setelah makan? (Skala 0-10) (0-10): 0
6. Seberapa yakin Anda baru saja makan makanan mencurigakan? (Skala 0-10) (0-10): 0
7. Seberapa parah perut kembung Anda? (Skala 0-10) (0-10): 5
8. Berapa kali Anda buang gas hari ini? (0-20): 3
9. Seberapa yakin gejala muncul setelah minum/makan olahan susu? (Skala 0-10) (0-10): 8
10. Seberapa stres Anda saat ini? (Skala 0-10) (0-10): 1
11. Seberapa lemas badan Anda? (Skala 0-10) (0-10): 0
```
```
Memproses diagnosa...

=== HASIL DIAGNOSA ===
- Intoleransi Laktosa: 50.00%
```